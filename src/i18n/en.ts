  ...
  translation: {
    ...
    lexicon: {
      ...
      lifecycle: {
        ...
        deprecatedSince: "Deprecated since language",
      },
      tabs: {
        qc: "Quality Check",
        statistics: "Statistics",
    ...
    sca: {
      ...
      importRuleSetTitle: "Import Sound Change Rule Set",
      importRuleSetHint:
        "Paste one rule per line. Supported formats:\n1) p t k -> b d g / V _ V\n2) target | replacement | before | after\n3) description | target | replacement | before | after | exceptions\n4) description | @feature | [target] | +set,-remove | [before] | [after] | exceptions",
      importRuleSetName: "Rule Set Name (optional)",
      importRuleSetNamePlaceholder: "e.g. Early Voicing",
      importRuleSetText: "Rule Text",
      importRuleSetPlaceholder: "One rule per line, paste multiple lines...",
      importRuleSetExample:
        "Examples:\np t k -> b d g / V _ V\ns -> h / _ #\nintervocalic voicing | p t k | b d g | V | V |\nfricativization | @feature | [+stop] | +fricative,-stop | [+#] | [+#] |",
      importRuleSetConfirm: "Parse & Import",
      importRuleSetParseFailed: "Parsing failed. Please check these lines:",
      importRuleSetNoRules: "No importable rules were found.",
      importRuleSetErrorLine: "Line {{line}}: {{source}}",
      importRuleSetMoreErrors:
        "{{count}} more lines have errors. Please fix and retry.",
      importRuleSetDefaultName: "Imported Rule Set",
      copyRuleSet: "Copy Rule Set",
      downloadRuleSet: "Download Rule Set",
      exportAllRuleSets: "Export All Rule Sets",
      copyRuleSetSuccess: "Rule set copied: {{name}}",
      copyRuleSetFailed: "Copy failed. Please check clipboard permission.",
      downloadRuleSetSuccess: "Rule set file downloaded: {{filename}}",
      downloadAllRuleSetsSuccess: "All rule sets exported: {{filename}}",
      exportAllRuleSetsEmpty: "There are no rule sets to export.",
      noRuleSets:
    ...
    tree: {
      ...
      updatedWordsAvailable: "{{count}} inherited words updated",
      pullAndEvolve: "Pull & Apply Sound Changes",
      upToDate: "All up to date!",
      syncConflicts: "{{count}} conflicted entries kept child-language version",
      previewMigration: "Preview Migration (dry-run)",
      migrateLegacy: "Migrate Legacy Entries",
      migrationDone:
        "Migration done: scanned {{scanned}}, affected files {{files}}, fixed parent links {{links}}, fixed source language {{source}}, fixed origin {{origin}}.",
      migrationPreviewDone:
        "Preview done (no writes): scanned {{scanned}}, would affect files {{files}}, fixed parent links {{links}}, fixed source language {{source}}, fixed origin {{origin}}.",
      migrationFailed: "Migration failed. See logs for details.",
      migrationPreviewFailed: "Migration preview failed. See logs for details.",
